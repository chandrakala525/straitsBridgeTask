...
@Component({
  selector: 'app-sitting-layout',
  templateUrl: './sitting-layout.component.html',
  styleUrls: ['./sitting-layout.component.css']
})
export class SittingLayoutComponent implements OnInit {
  title = 'UITask';
  goldData: Array<any> = [];
  ...
  ngOnInit(): void {
    this._getDataService.getSittingLayoutData().subscribe(res => {
